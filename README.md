<sup>*Edited from the info available at [https://www.gamebrew.org/wiki/DSAIM](https://www.gamebrew.org/wiki/DSAIM)*</sup>

# User Guide

### Login
- When the program starts, the log in screen should appear.
- Press select at the login screen will open the network connection setup. This will allow you to scan for access points.
...
- If it cannot connect to AIM, it will allow you to reinput your sn and password.
...
- The enter button on the keyboard drops to the next line. It does not send the IM.
- To send an IM, hit the Send button.
- Navigate your current input by using the up, down, left, and right arrows.
...
### Away Messages
- After typing your away message, use the Enter key to focus on the Ok/Cancel buttons.
